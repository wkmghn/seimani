...
function initializeStageList() {
    ...
    stages = [
        ...
        new StageInfo("N 5-C", 27, 3828, 0, undefined, undefined, UnitType.Heavy),
        new StageInfo("N 5-D", 27, 3822, 0, 水, undefined, UnitType.Ranged),
        ...
        new StageInfo("H 5-C", 42, 6131, 0, undefined, undefined, UnitType.Magic),
        new StageInfo("H 5-D", 43, 6383, 0, undefined, 水, UnitType.Melee),
