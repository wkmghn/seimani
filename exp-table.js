...
function initializeStageList() {
    ...
    stages = [
        ...
        new StageInfo("H 2-H", 28, 4785, 2480, [土, 日], 水, UnitType.Heavy),
        ...
        new StageInfo("N 4-B", 25, 4319, 2820, [土, 日], 水, UnitType.Heavy),
        ...
        new StageInfo("N 7-F", 28, 5310, 3550, [土, 日], 水, UnitType.Ranged),
        ...
        new StageInfo("H 7-B", 44, 8555, 5750, [土, 日], 水, UnitType.Ranged),
        ...
        new StageInfo("N 8-3", 29, 5940, 3770, [土, 日], 水, UnitType.Ranged),
