...
function initializeStageList() {
    ...
    stages = [
        ...
        new StageInfo("N 4-D", 26, 3211, 2950, undefined, undefined, UnitType.Melee),
        new StageInfo("N 4-E", 25, 2982, 2720, 木, undefined, UnitType.Ranged),
        ...
        new StageInfo("H 4-D", 42, 5454, 4770, undefined, undefined, UnitType.Melee),
        new StageInfo("H 4-E", 41, 5218, 4840, undefined, 木, UnitType.Ranged),
