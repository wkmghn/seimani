...
function initializeStageList() {
    ...
    stages = [
        ...
        new StageInfo("N 2-G", 12, 1905, 490, [木], 火, UnitType.Ranged),
        new StageInfo("N 2-H", 13, 2065, 550, [金], 水, UnitType.Melee),
        new StageInfo("N 2-2", 12, 1815, 630, [火, 水], 金, UnitType.Ranged),
        new StageInfo("N 2-A", 13, 2025, 890, [水], 土, UnitType.Heavy),
        new StageInfo("N 2-3", 13, 2067, 900, [木], 日, UnitType.Melee),
        new StageInfo("N 2-B", 14, 2245, 950, [金], 月, UnitType.Magic),
        new StageInfo("N 2-C", 15, 2400, 810, [土], 火, null),
        new StageInfo("N 2-I", 13, 2098, 670, [水, 土], 木, UnitType.Heavy),
        new StageInfo("N 2-4", 16, 2575, 870, [日, 金], 水, UnitType.Ranged),
        new StageInfo("N 2-D", 17, 2474, 1590, [月], 無, UnitType.Melee),
        ...
        new StageInfo("H 2-F", 28, 4720, 2480, [月], 無, UnitType.Ranged),
        new StageInfo("H 2-G", 28, 4771, 2540, [火, 金], 無, UnitType.Melee),
        new StageInfo("H 2-H", 28, 4785, 2480, [日], 水, UnitType.Heavy),
        new StageInfo("H 2-2", 23, 3814, 1800, [月], 木, UnitType.Ranged),
        new StageInfo("H 2-A", 24, 4057, 2830, [火], 金, UnitType.Melee),
        new StageInfo("H 2-3", 28, 4612, 2900, [水], 土, UnitType.Magic),
        new StageInfo("H 2-B", 29, 4820, 3070, [木], 日, UnitType.Ranged),
        new StageInfo("H 2-C", 29, 4861, 2140, [水, 金], 月, null),
        new StageInfo("H 2-I", 29, 4947, 2600, [木], 無, UnitType.Magic),
        new StageInfo("H 2-4", 31, 5318, 2210, [木, 土], 火, UnitType.Melee),
        new StageInfo("H 2-D", 36, 6011, 4280, [日], 無, UnitType.Heavy),
        ...
        new StageInfo("T 2-H", 38, 6598, 4060, [水], 火, UnitType.Ranged),
        new StageInfo("T 2-2", 38, 6494, 4220, [日], 土, UnitType.Ranged),
        new StageInfo("T 2-A", 38, 6400, 4250, [月, 水], 日, UnitType.Melee),
        new StageInfo("T 2-3", 39, 6897, 4210, [火], 月, UnitType.Melee),
        new StageInfo("T 2-B", 40, 6860, 4500, [水, 木], 火, UnitType.Heavy),
        new StageInfo("T 2-C", 40, 6940, 4260, [木], 水, UnitType.Melee),
        new StageInfo("T 2-I", 40, 6892, 4260, [木, 金], 水, UnitType.Magic),
        new StageInfo("T 2-4", 40, 6996, 4320, [金], 木, UnitType.Ranged),
        new StageInfo("T 2-D", 40, 7035, 4430, [土], 金, UnitType.Magic),
        new StageInfo("T 2-E", 40, 7051, 4290, [日, 木], 土, UnitType.Ranged),
        new StageInfo("T 2-J", 40, 7019, 4350, [金], 木, UnitType.Heavy),
        new StageInfo("T 2-K", 40, 7302, 4450, [土], 金, UnitType.Heavy),
        new StageInfo("T 2-5", 41, 7360, 4390, [日], 土, UnitType.Magic),
        new StageInfo("N 3-1", 19, 3114, 1940, [日], 金, UnitType.Ranged),
        new StageInfo("N 3-2", 19, 3141, 1960, [月, 木], 土, UnitType.Melee),
        new StageInfo("N 3-A", 19, 3158, 2560, [火], 無, UnitType.Magic),
        new StageInfo("N 3-3", 20, 3344, 2050, [水, 金], 月, UnitType.Heavy),
        new StageInfo("N 3-B", 20, 3398, 2670, [木], 無, UnitType.Melee),
        new StageInfo("N 3-C", 21, 3553, 2200, [金], 水, UnitType.Ranged),
        ...
        new StageInfo("H 3-2", 37, 6325, 4080, [木], 火, UnitType.Ranged),
        new StageInfo("H 3-A", 38, 6493, 4210, [金], 水, UnitType.Magic),
        new StageInfo("H 3-3", 38, 6580, 4190, [土], 木, UnitType.Ranged),
        new StageInfo("H 3-B", 39, 6716, 4370, [日], 金, UnitType.Melee),
        ...
        new StageInfo("T 3-1", 41, 7090, 4600, [金], 木, UnitType.Melee),
        new StageInfo("T 3-2", 41, 7281, 4640, [水, 土], 金, UnitType.Ranged),
        new StageInfo("T 3-A", 41, 7152, 4570, [日, 木], 土, UnitType.Magic),
        new StageInfo("T 3-F", 41, 7184, 4780, [月], 日, UnitType.Magic),
        new StageInfo("N 4-1", 25, 4211, 2740, [月], 木, UnitType.Magic),
        new StageInfo("N 4-2", 25, 4265, 2760, [火], 金, UnitType.Melee),
        new StageInfo("N 4-3", 25, 4348, 2770, [水], 土, UnitType.Ranged),
        new StageInfo("N 4-4", 26, 4609, 2860, [木], 日, UnitType.Ranged),
        new StageInfo("N 4-5", 26, 4616, 2860, [金], 月, UnitType.Magic),
        new StageInfo("N 4-A", 25, 4218, 2790, [金, 土], 火, UnitType.Melee),
        new StageInfo("N 4-B", 25, 4319, 2820, [日], 水, UnitType.Heavy),
        new StageInfo("N 4-C", 26, 4535, 2890, [月, 水], 木, UnitType.Heavy),
        new StageInfo("N 4-D", 26, 4559, 2950, [火, 木], 金, UnitType.Melee),
        new StageInfo("N 4-E", 25, 4234, 2720, [水], 土, UnitType.Ranged),
        new StageInfo("N 4-F", 25, 4331, 2750, [木], 日, UnitType.Ranged),
        new StageInfo("N 4-G", 26, 4551, 2870, [木, 金], 月, UnitType.Heavy),
        new StageInfo("N 4-H", 26, 4596, 2920, [水, 土], 火, UnitType.Melee),
        new StageInfo("H 4-1", 41, 7208, 4790, [金], 月, UnitType.Ranged),
        new StageInfo("H 4-2", 41, 7278, 4840, [土], 火, UnitType.Melee),
        new StageInfo("H 4-3", 41, 7297, 4740, [日], 水, UnitType.Magic),
        new StageInfo("H 4-4", 41, 7439, 4750, [月, 金], 木, UnitType.Melee),
        new StageInfo("H 4-5", 42, 7678, 4830, [火], 金, UnitType.Heavy),
        new StageInfo("H 4-A", 41, 7275, 4780, [水], 土, UnitType.Ranged),
        new StageInfo("H 4-B", 41, 7268, 4900, [木, 金], 日, UnitType.Magic),
        new StageInfo("H 4-C", 41, 7328, 4830, [金], 月, UnitType.Heavy),
        new StageInfo("H 4-D", 42, 7581, 4770, [水, 土], 火, UnitType.Magic),
        new StageInfo("H 4-E", 41, 7253, 4840, [日, 木], 水, UnitType.Melee),
        new StageInfo("H 4-F", 41, 7294, 4820, [月], 木, UnitType.Ranged),
        new StageInfo("H 4-G", 41, 7367, 4710, [火, 水], 金, UnitType.Melee),
        new StageInfo("H 4-H", 42, 7607, 4810, [水, 木], 土, UnitType.Ranged),
        new StageInfo("N 5-1", 26, 4544, 3120, [火], 金, UnitType.Ranged),
        new StageInfo("N 5-2", 26, 4646, 3130, [水, 金], 土, UnitType.Melee),
        new StageInfo("N 5-3", 27, 4779, 3150, [木], 日, UnitType.Heavy),
        new StageInfo("N 5-4", 27, 4874, 3110, [水, 金], 月, UnitType.Magic),
        new StageInfo("N 5-5", 27, 4908, 3090, [木, 土], 火, UnitType.Ranged),
        new StageInfo("N 5-A", 26, 4499, 3040, [日], 水, UnitType.Magic),
        new StageInfo("N 5-B", 27, 4808, 3140, [月], 木, UnitType.Melee),
        new StageInfo("N 5-C", 27, 4899, 3130, [火], 金, UnitType.Heavy),
        new StageInfo("N 5-D", 27, 4892, 3110, [水, 金], 土, UnitType.Ranged),
        new StageInfo("N 5-E", 26, 4552, 3130, [木], 日, UnitType.Melee),
        new StageInfo("H 5-1", 42, 7641, 5300, [木, 土], 火, UnitType.Ranged),
        new StageInfo("H 5-2", 42, 7702, 5050, [日], 水, UnitType.Heavy),
        new StageInfo("H 5-3", 42, 7783, 5110, [月], 木, UnitType.Ranged),
        new StageInfo("H 5-4", 42, 7849, 5300, [火, 水], 金, UnitType.Melee),
        new StageInfo("H 5-5", 43, 8139, 5270, [水, 金], 土, UnitType.Heavy),
        new StageInfo("H 5-A", 42, 7658, 5300, [木], 日, UnitType.Magic),
        new StageInfo("H 5-B", 42, 7809, 5200, [金], 月, UnitType.Melee),
        ...
        new StageInfo("N 6-1", 27, 4842, 3190, [水], 土, UnitType.Heavy),
        new StageInfo("N 6-2", 27, 4965, 3410, [木], 日, UnitType.Melee),
        new StageInfo("N 6-3", 27, 5009, 3400, [金], 月, UnitType.Magic),
        new StageInfo("N 6-4", 27, 5059, 3200, [土], 火, UnitType.Magic),
        new StageInfo("N 6-5", 28, 5290, 3420, [日, 木], 水, UnitType.Ranged),
        new StageInfo("N 6-A", 27, 4915, 3270, [月], 木, UnitType.Heavy),
        new StageInfo("N 6-B", 27, 4887, 3210, [火], 金, UnitType.Melee),
        new StageInfo("N 6-C", 27, 5032, 3390, [水], 土, UnitType.Ranged),
        new StageInfo("N 6-D", 28, 5190, 3550, [水, 木], 日, UnitType.Melee),
        new StageInfo("N 6-E", 27, 4935, 3430, [金], 月, UnitType.Ranged),
        new StageInfo("N 6-EX1", 35, 7503, 4760, [土], 火, UnitType.Ranged),
        new StageInfo("H 6-1", 43, 8008, 5370, [日, 木], 水, UnitType.Magic),
        new StageInfo("H 6-2", 43, 7999, 5390, [月, 水], 木, UnitType.Melee),
        new StageInfo("H 6-3", 43, 8025, 5330, [火], 金, UnitType.Ranged),
        new StageInfo("H 6-4", 43, 8184, 5360, [水], 土, UnitType.Heavy),
        new StageInfo("H 6-5", 44, 8354, 5500, [木], 日, UnitType.Heavy),
        new StageInfo("H 6-A", 43, 7914, 5360, [金], 月, UnitType.Ranged),
        new StageInfo("H 6-B", 43, 8048, 5390, [水, 土], 火, UnitType.Magic),
        new StageInfo("H 6-C", 43, 8104, 5370, [日, 木], 水, UnitType.Melee),
        new StageInfo("H 6-D", 44, 8294, 5470, [月], 木, UnitType.Magic),
        new StageInfo("H 6-E", 43, 8046, 5350, [火], 金, UnitType.Melee),
        new StageInfo("H 6-EX1", 55, 12067, 7710, [水], 土, UnitType.Ranged),
        new StageInfo("N 7-1", 28, 5193, 3470, [木], 日, UnitType.Ranged),
        new StageInfo("N 7-2", 28, 5301, 3460, [木, 金], 月, UnitType.Melee),
        new StageInfo("N 7-3", 28, 5392, 3540, [水, 土], 火, UnitType.Heavy),
        new StageInfo("N 7-4", 28, 5412, 3490, [金, 日], 水, UnitType.Magic),
        new StageInfo("N 7-5", 28, 5467, 3520, [月], 木, UnitType.Melee),
        new StageInfo("N 7-A", 28, 5260, 3490, [火], 金, UnitType.Heavy),
        new StageInfo("N 7-B", 28, 5324, 3520, [水], 土, UnitType.Ranged),
        new StageInfo("N 7-C", 28, 5387, 3490, [木], 日, UnitType.Magic),
        new StageInfo("N 7-D", 28, 5436, 3530, [金], 月, UnitType.Ranged),
        new StageInfo("N 7-E", 28, 5297, 3510, [水, 土], 火, UnitType.Melee),
        new StageInfo("N 7-F", 28, 5310, 3550, [日], 水, UnitType.Ranged),
        ...
        new StageInfo("H 7-2", 44, 8599, 5700, [火], 金, UnitType.Magic),
        ...
        new StageInfo("H 7-B", 44, 8555, 5750, [日], 水, UnitType.Ranged),
        new StageInfo("H 7-C", 44, 8635, 5680, [月], 木, UnitType.Heavy),
        new StageInfo("H 7-D", 45, 8915, 5870, [火], 金, UnitType.Melee),
        new StageInfo("H 7-E", 44, 8569, 5740, [水], 土, UnitType.Magic),
        new StageInfo("H 7-F", 44, 8580, 5730, [木], 日, UnitType.Ranged),
        ...
        new StageInfo("H 8-EX3", 55, 12155, 7760, [金], 水, UnitType.Heavy),
