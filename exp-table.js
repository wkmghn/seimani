...
function initializeStageList() {
    ...
    stages = [
        ...
        new StageInfo("T 2-D", 40, 4397, 0, undefined, 金, UnitType.Magic),
        ...
        new StageInfo("T 3-1", 41, 3920, 4600, 金, 木, UnitType.Melee),
        new StageInfo("T 3-2", 41, 3914, 0, undefined, 金, UnitType.Ranged),
